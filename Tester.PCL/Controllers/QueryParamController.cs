...
namespace Tester.PCL.Controllers
{
    public partial class QueryParamController: BaseController, IQueryParamController
    {
        ...
        /// TODO: type endpoint description here
        /// </summary>
        /// <param name="MultipleParamsInput">Object containing request parameters</param>
        /// <return>Returns the ServerResponse response from the API call</return>
        public ServerResponse MultipleParams(MultipleParamsInput input)
        {
            Task<ServerResponse> t = MultipleParamsAsync(input);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="MultipleParamsInput">Object containing request parameters</param>
        /// <return>Returns the ServerResponse response from the API call</return>
        public async Task<ServerResponse> MultipleParamsAsync(MultipleParamsInput input)
        {
            //validating required parameters
            if (null == input.String)
                throw new ArgumentNullException("mstring", "The property \"String\" in the input object cannot be null.");
        ...
        /// TODO: type endpoint description here
        /// </summary>
        /// <param name="SimpleQueryInput">Object containing request parameters</param>
        /// <param name="queryParameters">Additional optional query parameters are supported by this endpoint</param>
        /// <return>Returns the ServerResponse response from the API call</return>
        public ServerResponse SimpleQuery(SimpleQueryInput input, Dictionary<string, object> queryParameters = null)
        {
            Task<ServerResponse> t = SimpleQueryAsync(input, queryParameters);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="queryParameters">Additional optional query parameters are supported by this endpoint</param>
        /// <return>Returns the ServerResponse response from the API call</return>
        public async Task<ServerResponse> SimpleQueryAsync(SimpleQueryInput input, Dictionary<string, object> queryParameters = null)
        {
            //validating required parameters
            if (null == input.String)
                throw new ArgumentNullException("mstring", "The property \"String\" in the input object cannot be null.");
