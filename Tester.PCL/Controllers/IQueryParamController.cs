...
namespace Tester.PCL.Controllers
{
    public partial interface IQueryParamController
    {
        ...
        /// <return>Returns the ServerResponse response from the API call</return>
        ServerResponse MultipleParams(MultipleParamsInput input);
        ...
        /// <param name="MultipleParamsInput">Object containing request parameters</param>
        /// <return>Returns the ServerResponse response from the API call</return>
        Task<ServerResponse> MultipleParamsAsync(MultipleParamsInput input);
        ...
        /// <return>Returns the ServerResponse response from the API call</return>
        ServerResponse SimpleQuery(SimpleQueryInput input, Dictionary<string, object> queryParameters = null);
        ...
        /// <param name="queryParameters">Additional optional query parameters are supported by this endpoint</param>
        /// <return>Returns the ServerResponse response from the API call</return>
        Task<ServerResponse> SimpleQueryAsync(SimpleQueryInput input, Dictionary<string, object> queryParameters = null);
