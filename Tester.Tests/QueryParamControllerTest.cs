...
namespace Tester.Tests
{
    ...
    public class QueryParamControllerTest : ControllerTestBase
    {
        ...
        public async Task TestMultipleParams() 
        {
            ...
            input.Number = 123412312;
            input.Precision = 1112.34;
            input.String = "\"\"test./;\";12&&3asl\"\";\"qw1&34\"///..//.";
            input.Url = "http://www.abc.com/test?a=b&c=\"http://lolol.com?param=no&another=lol\"";
            ...
            try
            {
                result = await controller.MultipleParamsAsync(input);
            }
            catch(APIException) {};
        ...
        public async Task TestSimpleQuery() 
        {
            ...
            try
            {
                result = await controller.SimpleQueryAsync(input, queryParams);
            }
            catch(APIException) {};
